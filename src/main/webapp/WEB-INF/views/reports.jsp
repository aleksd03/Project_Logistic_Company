...
<%
    ...
    // ===== Statistics provided by ReportsServlet =====
    ...
    <main>
        ...
        <div class="stats-grid">
            ...
            <a href="${pageContext.request.contextPath}/employee-shipments"
               class="stat-card blue clickable">
                <div class="stat-card-icon">📦</div>
                <div class="stat-card-value blue">
                    <%= totalShipments != null ? totalShipments : 0 %>
                </div>
                <div class="stat-card-label">Общо пратки</div>
            </a>

            <!-- Active deliveries -->
            <a href="${pageContext.request.contextPath}/undelivered-shipments"
               class="stat-card orange clickable">
                <div class="stat-card-icon">🚚</div>
            ...
            <div class="stat-card green">
                ...
                <div class="stat-card-value green">
                    <%= completedDeliveries != null ? completedDeliveries : 0 %>
                </div>
            ...
            <a href="${pageContext.request.contextPath}/revenue-report"
               class="stat-card green clickable">
                <div class="stat-card-icon">💰</div>
                <div class="stat-card-value green">
                    <%= totalRevenue != null ? String.format("%.2f", totalRevenue) : "0.00" %>€
                </div>
        ...
        <div class="card">
            ...
            <div class="report-list">
                ...
                <div class="report-item">
                    ...
                    <a href="${pageContext.request.contextPath}/monthly-stats"
                       class="btn btn-primary">Виж</a>
                </div>
        ...
        <div class="quick-stats-grid">
            ...
            <div class="quick-stat-card">
                ...
                <div class="quick-stat-content">
                    <div class="quick-stat-item">
                        <div class="quick-stat-value blue">
            ...
            <div class="quick-stat-card">
                ...
                <div class="quick-stat-content">
                    <div class="quick-stat-item">
                        <div class="quick-stat-value orange">
                            <%= activeDeliveries != null ? activeDeliveries : 0 %>
                        </div>
                        <div class="quick-stat-label">В процес</div>
                    </div>
                    <div class="quick-stat-item">
                        <div class="quick-stat-value green">
                            <%= completedDeliveries != null ? completedDeliveries : 0 %>
                        </div>
